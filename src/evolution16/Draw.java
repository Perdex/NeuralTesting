    ...
    public void paint(Graphics g){
        ...
        try{
            ...
            if(selected != null){
                ...
                int c;
                ArrayList<Brain.neuron> neurons = selected.getNeurons();
                for(int i = 0; i < neurons.size(); i++){
                    ...
                    for(int j = 0; j < 6; j++){
                        ...
                        g.drawLine(w - 190, 30 + i * 260 / neurons.size(), w - 340, 30 + j * 40);
                    }
                ...
                for(int i = 0; i < 6; i++){
                    ...
                    c = Math.min(c, 255);
                    g.setColor(new Color(c, c, c));
                    g.fillOval(w - 350, 20 + i * 40, 20, 20);
                    g.setColor(Color.black);
                    g.drawOval(w - 350, 20 + i * 40, 20, 20);
                }
                for(int i = 0; i < 2; i++){
